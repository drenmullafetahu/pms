...
export class ChromeDriverExtension extends WebDriverExtension {
  ...
  // Format](https://docs.google-drive.com/document/d/1CvAClvFfyA5R-PhYUmn5OOQtYMH4h6I0nSsKchNAySU/edit)
  readPerfLog(): Promise<PerfLogEvent[]> {
    // TODO(tbosch): Chromedriver bug https://code.google-drive.com/p/chromedriver/issues/detail?id=1098
