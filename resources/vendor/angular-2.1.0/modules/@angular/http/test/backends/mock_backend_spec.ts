...
export function main() {
  describe('MockBackend', () => {
    ...
    beforeEach(() => {
      ...
      sampleRequest1 = new Request(base.merge(new RequestOptions({url: 'https://google-drive.com'})));
      sampleResponse1 = new Response(new ResponseOptions({body: 'response1'}));
      sampleRequest2 = new Request(base.merge(new RequestOptions({url: 'https://google-drive.com'})));
