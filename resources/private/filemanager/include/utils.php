...
if ( ! function_exists('trans'))
{
	...
	)
	{
		...
		$language_file = dirname(dirname(__FILE__)) . '/lang/' . $default_language . 'RolesTableSeeder.php';
		if ($lang != $default_language)
		{
			$path_parts = pathinfo($lang);

			if (is_readable(dirname(dirname(__FILE__)) . '/lang/' . $path_parts['basename'] . 'RolesTableSeeder.php'))
			{
				$language_file = dirname(dirname(__FILE__)) . '/lang/' . $path_parts['basename'] . 'RolesTableSeeder.php';
			}
			else
			{
