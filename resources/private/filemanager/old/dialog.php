...
$language_file = 'lang/'.$default_language.'RolesTableSeeder.php';
if ($lang!=$default_language) {
    $path_parts = pathinfo($lang);
    if(is_readable('lang/' .$path_parts['basename']. 'RolesTableSeeder.php')){
        $language_file = 'lang/' .$path_parts['basename']. 'RolesTableSeeder.php';
    }
    else {
