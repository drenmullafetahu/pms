...
$base_url ="http://".$_SERVER['HTTP_HOST'].'/cms/';  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/repository/'; // path from base_url to base of upload folder (with start and final /)
$current_path = $_SERVER['DOCUMENT_ROOT'].'/uploads'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = $_SERVER['DOCUMENT_ROOT'].'/uploads/'; // relative path from filemanager folder to thumbs folder (with final /)
