<div class="modal fade" id="delete-task-{{$activity['id']}}" tabindex="-1" role="dialog" aria-labelledby="edit"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::model($activity, ['method'=>'DELETE', 'action' => ['ActivitiesController@destroy', $activity['id']]]) !!}
            ...
            <div class="modal-body">
                <div class="alert alert-danger"><i class="fa fa-exclamation-triangle fa-lg margin-r-5"></i> Are you sure
                    you want to delete "{{$activity['activity_title']}}"?
                </div>
            </div>
