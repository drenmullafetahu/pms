...
?>
<div class="modal fade" id="edit-task-{{$activity['id']}}" tabindex="-1" role="dialog" aria-labelledby="edit"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title custom_align" id="Heading"><i class="fa fa-edit fa-2x text-aqua margin-r-4"></i>
                    Edit -
                    <small>{{$activity['activity_title']}}</small>
                </h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" class="form-control" value="{{$activity['activity_title']}}"
                           name="activity_title" placeholder="">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="textarea" name="activity_description"
                              style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$activity['activity_description']}}</textarea>
                </div>
